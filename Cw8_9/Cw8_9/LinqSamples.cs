    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            {
                Console.WriteLine(x.Ename + ":  " + x.Job);
            }
        ...
        public void Przyklad2()
        {
            ...
            {
                Console.WriteLine(x.Ename + ":  " + x.Job+":  " + x.Salary);
            }
        }
        ...
        {
            var res = Emps
                .Where(x => x.Salary == Emps.Select(y => y.Salary).Max())
                .Select(x=> new
                {
                    x.Ename,
                    x.Salary
        ...
        public void Przyklad5()
        {
            ...
            foreach (var x in res)
            {
                Console.WriteLine(x.Nazwisko + ":  " + x.Praca);
            }
        ...
        public void Przyklad6()
        {
            ...
            foreach (var x in res)
            {
                Console.WriteLine(x.Ename + ":  " + x.Job + ":  " + x.Dname);
            }
        }
    ...
    public void Przyklad7()
        {
            ...
            foreach (var x in res)
            {
                Console.WriteLine(x.Praca + ":  " + x.LiczbaPracownikow);
            }
        ...
        public void Przyklad12()
        {
            ...
            foreach (var x in res)
            {
                Console.WriteLine(x.Ename + ":  " + x.Salary + ":  " + x.Dname);
            }
